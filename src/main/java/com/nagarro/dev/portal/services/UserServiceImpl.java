...
public class UserServiceImpl implements UserService {
	...
	public void createUser(Users user) {	// Add a User (Works)
		String initpass ="hello"; //passcode
		System.out.println(user.toString());
		user.setPassword(bpe.encode(initpass));
		usersRepository.save(user);
		
		System.out.println(initUsername( user.getEmail(), user.getUsername(), user.getFirstName(), initpass));
	}
